...
class FOFController extends FOFUtilsObject
{
        ...
        foreach ($classSuffixes as $suffix) {
            ...
            if (!empty($format)) {
                $path = $filesystem->pathFind(
                    $searchPaths,
                    strtolower($suffix) . '.' . strtolower($format) . '.php'
                );
            }
    ...
    public function __construct($config = array())
    {
        ...
        $altBasePath = $this->configProvider->get(
            ...
            FOFInflector::singularize($this->view) . '.config.base_path',
            null
        );
        ...
        $defaultTask = $this->configProvider->get(
            $this->component . '.views.' .
            FOFInflector::singularize($this->view) . '.config.default_task',
            'display'
        );
        ...
        if (empty($this->model_prefix)) {
            if (array_key_exists('model_prefix', $config)) {
                ...
                $this->model_prefix = $this->configProvider->get(
                    $this->component . '.views.' .
                    FOFInflector::singularize($this->view) . '.config.model_prefix',
                    $this->model_prefix
                );
            }
        }
        ...
        if (array_key_exists('model_path', $config)) {
            ...
            $altModelPath = $this->configProvider->get(
                $this->component . '.views.' .
                FOFInflector::singularize($this->view) . '.config.model_path',
                null
            );
        ...
        if (array_key_exists('view_path', $config)) {
            ...
            $altViewPath = $this->configProvider->get(
                $this->component . '.views.' .
                FOFInflector::singularize($this->view) . '.config.view_path',
                null
            );
        ...
        if (array_key_exists('default_view', $config)) {
            ...
            $this->default_view = $this->configProvider->get(
                $this->component . '.views.' .
                FOFInflector::singularize($this->view) . '.config.default_view',
                $this->default_view
            );
        }
        ...
        $this->csrfProtection = $this->configProvider->get(
            $this->component . '.views.' .
            FOFInflector::singularize($this->view) . '.config.csrf_protection',
            $this->csrfProtection
        );
        ...
        if (array_key_exists('viewName', $config)) {
            ...
            $overrideViewName = $this->configProvider->get(
                $this->component . '.views.' .
                FOFInflector::singularize($this->view) . '.config.viewName',
                null
            );
        ...
        if (array_key_exists('modelName', $config)) {
            ...
            $overrideModelName = $this->configProvider->get(
                $this->component . '.views.' .
                FOFInflector::singularize($this->view) . '.config.modelName',
                null
            );
        ...
        if (array_key_exists('cacheableTasks', $config)) {
            ...
            $cacheableTasks = $this->configProvider->get(
                $this->component . '.views.' .
                FOFInflector::singularize($this->view) . '.config.cacheableTasks',
                null
            );
        ...
        $this->autoRouting = $this->configProvider->get(
            $this->component . '.views.' .
            FOFInflector::singularize($this->view) . '.config.autoRouting',
            $this->autoRouting
        );
    ...
    protected function onBeforeAccesspublic()
    {
        $privilege = $this->configProvider->get(
            $this->component . '.views.' .
            FOFInflector::singularize($this->view) . '.acl.accesspublic',
            'core.edit.state'
        );
    ...
    protected function onBeforeAccessregistered()
    {
        $privilege = $this->configProvider->get(
            $this->component . '.views.' .
            FOFInflector::singularize($this->view) . '.acl.accessregistered',
            'core.edit.state'
        );
    ...
    protected function onBeforeAccessspecial()
    {
        $privilege = $this->configProvider->get(
            $this->component . '.views.' .
            FOFInflector::singularize($this->view) . '.acl.accessspecial',
            'core.edit.state'
        );
